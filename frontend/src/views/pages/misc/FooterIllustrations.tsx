...
const FooterIllustrations = (props: FooterIllustrationsProp) => {
  ...
  if (!hidden) {
    return (
      <Fragment>
        {image || <TreeImg alt='tree' src='/decentralized-SLA/images/pages/tree-2.png' />}
        <MaskImg alt='mask' src={`/decentralized-SLA/images/pages/misc-mask-${theme.palette.mode}.png`} />
      </Fragment>
    )
  } else {
    return null
